...
export default function Navbar() {
  return (
    <div className=" dark:bg-bl-1   flex items-center  h-24 justify-center ">
      <div className=" h-24 dark:bg-bl-1  dark:text-bd-1 bg-bd-1 text-bl-1  flex gap-8 justify-end w-full items-center pr-20 ">
        {/* <Link 
