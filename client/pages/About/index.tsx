          ...
          <div className="mobile:flex gap-20 mobile:flex-col grid grid-cols-2 ">
            <div className="">
              <div className="   ">
                ...
                <div className="flex  mobile:justify-start sm:justify-start  justify-end ">
                  <div className=" bg-bl-1 rounded text-bd-1 w-fit mb-4 p-2 flex text-3sm font-semibold">
            ...
            <div className="flex flex-col ">
              ...
              <div className="flex flex-col justify-end">
                ...
                <div className="bg-bl-1 rounded text-bd-1 w-fit mt-4 mb-4 p-2 flex text-3sm font-semibold">
